...
<html>
    ...
    <div style="text-align:center;">
        ...
        <?php /* WARNING: It is against the terms of the CPL to remove or alter the following line.  The 'Powered by Utkallabs' line must stay visible on every page. */ ?>
        <div id="poweredCATS">
		<a href="http://www.utkallabs.com" target="_blank"><img src="images/applicationLogo.jpg" alt="Powered by: Utkallabs - Applicant Tracking System" title="Powered by: Utkallabs - Applicant Tracking System" /></a>
		</div>
    </div>
