...
<?php TemplateUtility::printModalHeader('Candidates', array('modules/candidates/validator.js'), 'Create Candidate Attachment'); ?>
    ...
    <?php } else { ?>
        <?php if(isset($this->resumeText) && $this->resumeText == ''): ?>
            <p>The file has been successfully attached, but <strong>UL ATS</strong> was unable to index the resume keywords to make the document searchable.  The file format may be unsupported by <strong>UL ATS.</p>
        <?php else: ?>
