...
define('DATABASE_USER', 'docker-user');
define('DATABASE_PASS', 'password');
define('DATABASE_HOST', 'ats-mysql-db');
define('DATABASE_NAME', 'ats-docker');
...
define('MAIL_SMTP_USER', "susil.behera@utkallabs.com");
define('MAIL_SMTP_PASS', "Susil@9146");
//Options: '', 'ssl' or 'tls'
...
This is a reminder from the UL ATS Applicant Tracking System about an
upcoming event.
...
--
Utkal Labs Applicant Tracking System
EOF;


/* Set Hr mail. */
//define('CONFIG_HR_MAIL', "hr@utkallabs.com");  //Production
define('CONFIG_HR_MAIL', "sbpriyaaparajita@gmail.com");

/* Set forgot password mail. */
define('PASSWORD_RESET_SUBJECT', 'Your Password Reset Subject');
define('PASSWORD_RESET_BODY', 'Your Password Reset Body');
